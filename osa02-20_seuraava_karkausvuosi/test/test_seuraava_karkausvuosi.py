...
class PinTest(unittest.TestCase):
    ...
    def test_2019(self):
        with patch('builtins.input', side_effect= ["2019", AssertionError("Syötettä pyydetään liian monta kertaa.") ], ) as prompt:
            ...
            self.assertEqual(expected, output, f"Syötteellä 2019 ohjelmasi pitäisi tulostaa \n{expected}\nohjelmasi tulosti\n{output}" )
    ...
    def test_2020(self):
        with patch('builtins.input', side_effect= ["2020", AssertionError("Syötettä pyydetään liian monta kertaa.") ], ) as prompt:
            ...
            self.assertEqual(expected, output, f"Syötteellä 2020 ohjelmasi pitäisi tulostaa \n{expected}\nohjelmasi tulosti\n{output}" )
    ...
    def test_1896(self):
        with patch('builtins.input', side_effect= ["1896", AssertionError("Syötettä pyydetään liian monta kertaa.") ], ) as prompt:
            ...
            self.assertEqual(expected, output, f"Syötteellä 1896 ohjelmasi pitäisi tulostaa \n{expected}\nohjelmasi tulosti\n{output}" )
    ...
    def test_neljalla_jaolliset(self):
        ...
        for value in values:
            ...
            with patch('builtins.input', return_value = str(acual_value)):
                ...
                self.assertEqual(expected, output, f"Syötteellä '{acual_value}' ohjelmasi pitäisi tulostaa \n{expected}\nohjelmasi tulosti\n{output}" )
