    ...
    def test_eka_vanhempi(self):
        ...
        for valuegroup in values:
            with patch('builtins.input', side_effect = list(valuegroup)):
                ...
                self.assertTrue(output[0].find(valuegroup[0]) > -1, "Tulostuksesta {} ei löydy vanhemman henkilön nimeä {} kun syöte on:\n{}".
                    format(output[0], valuegroup[0], format_tuple(valuegroup)))
                self.assertFalse(output[0].find(valuegroup[2]) > -1, "Tulostuksesta {} löytyi nuoremman henkilön nimi {} kun syöte on\n{}".
    ...
    def test_toka_vanhempi(self):
        ...
        for valuegroup in values:
            with patch('builtins.input', side_effect = list(valuegroup)):
                ...
                self.assertTrue(len(output) == 1, "Ohjelmasi tulostaa kyselyjen jälkeen yhden rivin sijasta {} riviä: {} syötteellä:\n{}".format(len(output), output, format_tuple(valuegroup)))
                self.assertTrue(output[0].find(valuegroup[2]) > -1, "Tulostuksesta {} ei löydy vanhemman henkilön nimeä {} kun syöte on:\n{}".
                    format(output[0], valuegroup[2], format_tuple(valuegroup)))
                self.assertFalse(output[0].find(valuegroup[0]) > -1, "Tulostuksesta {} löytyi nuoremman henkilön nimi {} kun syöte on:\n{}".
                    format(output[0], valuegroup[0], format_tuple(valuegroup)))
    ...
    def test_yhta_vanhat(self):
        ...
        for valuegroup in values:
            with patch('builtins.input', side_effect = list(valuegroup)):
                ...
                self.assertTrue(len(output) == 1, "Ohjelmasi tulostaa kyselyjen jälkeen yhden rivin sijasta {} riviä: {} syötteellä:\n{}".format(len(output), output, format_tuple(valuegroup)))
                self.assertTrue(output[0].find(valuegroup[0]) > -1, "Tulostuksesta {} ei löydy nimeä {} kun syöte on:\n{}".
                    format(output[0], valuegroup[0], format_tuple(valuegroup)))
                self.assertTrue(output[0].find(valuegroup[2]) > -1, "Tulostuksesta {} ei löydy nimeä {} kun syöte on:\n{}".
                    format(output[0], valuegroup[2], format_tuple(valuegroup)))
                self.assertTrue(output[0].find("yhtä vanhoja") > -1, "Tulostuksesta {} ei löydy mainintaa 'yhtä vanhoja'".format(output[0]))
