    ...
    def test_neljalla_jaolliset(self):
        ...
        for value in values:
            with patch('builtins.input', return_value = value):
                ...
                self.assertTrue(output[0].lower().strip().find("on karkausvuosi") > -1, "Tulostus {} ei vastaa oikeaa tulostetta {} kun syöte on {}".
    ...
    def test_ei_neljalla_jaolliset(self):
        ...
        for value in values:
            with patch('builtins.input', return_value = value):
                ...
                self.assertTrue(len(output) == 1, "Ohjelmasi tulostaa yhden rivin sijasta {} riviä: {} kun syöte on {}".format(len(output), output, value))
                self.assertTrue(output[0].lower().strip().find("ei ole karkausvuosi") > -1, "Tulostus {} ei vastaa oikeaa tulostetta {} kun syöte on {}".
